      ...
      <div class="product-card reveal" onclick="openProductModal('${p.id}')">
        <div class="product-card-image-wrap">
          ...
          <div class="product-card-overlay">
            <span class="view-detail-hint">${SITE_CONTENT.ui.exploreDetails}</span>
          </div>
        </div>
...
window.openProductModal = (id) => {
  ...
  content.innerHTML = `
    ...
    <div class="modal-info-panel">
      ...
      <span class="modal-color">${SITE_CONTENT.ui.colorLabel}: ${product.color}</span>
      ...
      <div class="modal-accordion">
        <div class="accordion-item active">
          <button class="accordion-header" onclick="toggleModalAccordion(this)">
            <span>${SITE_CONTENT.ui.specsTab}</span>
        ...
        <div class="accordion-item">
          <button class="accordion-header" onclick="toggleModalAccordion(this)">
            <span>${SITE_CONTENT.ui.careTab}</span>
            <svg class="chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"></polyline></svg>
          </button>
        ...
        <div class="accordion-item">
          <button class="accordion-header" onclick="toggleModalAccordion(this)">
            <span>${SITE_CONTENT.ui.sizesTab}</span>
            <svg class="chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"></polyline></svg>
          </button>
          <div class="accordion-content">
            <p>${SITE_CONTENT.ui.sizesIntro}</p>
