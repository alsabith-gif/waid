...
function initMobileMenu() {
  ...
  const hideMenu = () => mobileMenu.classList.remove("active");
...
window.openProductModal = (id) => {
  ...
  content.innerHTML = `
    ...
    <a href="#contact" class="modal-inquire-btn" onclick="inquireProduct('${product.name}')">
      Inquire
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
    </a>
  `;
...
window.inquireProduct = (name) => {
  ...
  if (msgInput) {
    msgInput.value = `Hello, I am interested in inquiring details about the model: "${name}". Could you provide details on custom fitting slots?`;
    msgInput.focus();
  }
};
